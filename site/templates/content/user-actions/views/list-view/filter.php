	...
	<div class="row">
		...
		<div class="col-xs-6">
			<?php if ($input->get->filter) : ?>
				<a href="<?= $actionpanel->generate_clearfilterurl(); ?>" class="btn btn-sm btn-warning load-link" data-loadinto="<?= $actionpanel->loadinto; ?>" data-focus="<?= $actionpanel->focus; ?>"><i class="fa fa-times" aria-hidden="true"></i> Clear Filter</a>
			<?php endif; ?>
		</div>
	</div>
</form>